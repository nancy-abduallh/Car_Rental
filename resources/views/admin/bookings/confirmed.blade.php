    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header animated fadeInDown">
                <h2 class="page-title">
                    <i class="fas fa-check-circle text-success me-2"></i>Confirmed Bookings
                </h2>
                <p class="page-subtitle">View all confirmed rental bookings</p>
            </div>
            ...
            <div class="card modern-card animated fadeInUp">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="confirmedBookingsTable" class="table table-hover table-striped modern-table"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $('#confirmedBookingsTable').DataTable({
                "language": {
                    "search": "<i class='fas fa-search'></i>",
                    "searchPlaceholder": "Search confirmed bookings...",
                    "lengthMenu": "Show _MENU_ entries",
                    "info": "Showing _START_ to _END_ of _TOTAL_ confirmed bookings",
                    "paginate": {
